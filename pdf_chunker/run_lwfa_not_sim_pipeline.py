#!/usr/bin/env python3
"""
LWFA (not simulation): "laser wakefield acceleration" AND NOT "simulation"
→ 300 papers → 5 buckets (new-lwfa-not-sim-1 .. new-lwfa-not-sim-5)
...
QUERY = {
    "and": [{"field": "all", "value": "laser wakefield acceleration"}],
    "groups": [],
    "not": [{"field": "all", "value": "simulation"}],
    "limit": 300,
}
...
if __name__ == "__main__":
    ...
    try:
        sys.exit(run_pipeline(
            query_payload=QUERY,
            bucket_prefix="new-lwfa-not-sim",
